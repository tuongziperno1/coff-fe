          ...
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0">
                ...
                >
                  Blend Coffee là sự kết hợp hoàn hảo của nhiều loại hạt cà phê, tạo ra hương vị độc đáo, cân bằng. Với sự pha trộn tinh tế, mỗi tách mang đến trải nghiệm phong phú và đậm đà.
                </p>
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  >
                    ...
                    Giống như việc viết CODE, pha một tách trà hoàn hảo đòi hỏi sự kiên nhẫn, chính xác và một chút đam mê để tạo ra sự kết hợp hương vị đầy thoải mái.
                    </p>
                  </div>
                </div>
              </div>
